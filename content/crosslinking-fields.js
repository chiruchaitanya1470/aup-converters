...
var anchorlinksposition=0;
//team section from hero banner
var teammembers=document.getElementsByClassName('team-member col-xs-12 col-sm-6 col-md-4 col-lg-12');
for(var i=0;i<teammembers.length;i++){
        var hrefLink=teammembers[i].querySelector('figure>a').href;
        var crosslinkkingvalue=crosslinkking(hrefLink);
        anchorLinksSet.add(hrefLink);
        var divElement= newElementCreator(crosslinkkingvalue);
        divElement.style.left='-800px';
        divElement.style.top='-55px';
        teammembers[i].appendChild(divElement);
